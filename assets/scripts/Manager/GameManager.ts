...
export class GameManager extends Component {
    ...
    ClearData() {
        ...
        this.scheduleOnce(() => {
            if (this.sampleJson.rounds[this.indexCurrentReel].flips.length > 0) {
                this.FlipData(() => {
                    console.log(this.sampleJson.rounds[this.indexCurrentReel].above, this.indexCurrentReel, this.sampleJson.rounds)
    ...
    ShowBigWin() {
        console.log("check Me", this.sampleJson.rounds[this.indexCurrentReel].BigWin > 0)
