...
export class PanelBet extends Component {
    ...
    @property(Label)
    labelWallet2: Label = null;

    @property(Label)
    labelWin2: Label = null;
    ...
    getFromLabelBet() {
        this.csBetSize.scrollToValue(this.labelWallet.getComponent(LabelBet).stepBet)
        this.csBetLevel.scrollToValue(Math.floor(this.labelWallet.getComponent(LabelBet).betAmount / this.labelWallet.getComponent(LabelBet).stepBet));
    }
